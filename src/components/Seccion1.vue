<template>
  <div id="Seccion1">
    <h3 class="bienvenida">Bienvenido/a, mi nombre es</h3>
    ...
    <div class="botones1">
      <a
        ...
        >Descargar CV</a
      >
      <a href="https://wa.link/bw0b1w" class="botonB">Contactar</a>
    </div>
    <div class="redes">
      <a
        href="https://www.linkedin.com/in/rene-ramirez-6674b31a5/"
        target="_BLANK"
      >
        <svg
          class="icon"
      ...
      <a href="https://github.com/reneraesp" target="_BLANK">
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 496 512"
      ...
      <a href="https://t.me/rrteam7" target="_BLANK">
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 496 512"
      ...
      <a href="https://wa.link/bw0b1w" target="_BLANK">
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
...
#Seccion1 {
  ...
  .redes {
    ...
    border: 3.4px solid rgba(20, 156, 77, 0.452);
