<template>
    <div id="Seccion1">
        ...
        <div class="botones1">
            <button class="botonA">Descargar CV</button>
            <button class="botonB">Contactar</button>
        </div>
        <div class="redes">
            <a href="#">
            <svg class="linkedIn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
#Seccion1 {
    ...
    .redes {
        ...
        border: 5px solid rgb(20, 156, 77);
