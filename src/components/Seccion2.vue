  ...
  <div class="Seccion2">
    ...
    <div class="sobre">
      <div class="izquierda">
        <img
          class="foto"
          src="./../assets/img/photo_2022-06-04_14-49-29.jpg"
          alt="Foto Rene Ramirez Desarrollador Web"
        />
        <div class="sobremiP">
          <p>
      ...
      <div class="derecha">
        ...
        <div class="box">
          ...
          <p class="cuerpo">
            Experiencia trabajando en equipos multiculturales con herramientas
            destinadas a ello como: Git, Github, Trello, Discord entre otras
          </p>
        </div>
        <div class="box box4">
          <svg
