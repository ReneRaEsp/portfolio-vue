        ...
        <div class="sobre">
            ...
            <div class="derecha">
                ...
                <div class="box">
                    ...
                    <h2 class="encabezado">Proyectos</h2>
                    <p class="cuerpo">+20 Proyectos</p>
                </div>
                <div class="box">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                        <path
                            fill="rgba(107, 50, 133, 0.945)"
                    ...
                    <h2 class="encabezado">Co-Work</h2>
                    <p
                        class="cuerpo"
                    >Experiencia trabajando en equipos multiculturales con herramientas destinadas a ello como: Git, Github, Trello, Discord entre otras</p>
                </div>
                <div class="box box4">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                        <path
                            fill="rgba(158, 18, 18, 0.945)"
                    ...
                    <p class="cuerpo">Comprension/Lectura: avanzado, Hablado: intermedio</p>
                </div>
            </div>
        </div>
    </div>
...
.Seccion2 {
    ...
    .sobre {
        ...
        .izquierda {
            width: 49%;
            height: 50rem;
            background: rgba(95, 95, 95, 0.432);
        }
        .derecha {
            display: flex;
            justify-content: space-evenly;
            ...
            .box {
                ...
                width: 40%;
                height: 14rem;
                background: rgba(10, 85, 26, 0.349);
                border: 3px solid rgba(34, 194, 47, 0);
                border-radius: 1.2rem;
                transition: 1.2s;
                &:hover {
                    border: 3px solid rgba(34, 194, 48, 0.726);
                    background: rgba(0, 0, 0, 0.226);
                    color: rgba(158, 18, 18, 0.945);
                    cursor: pointer;
                }
                .icon {
                    margin: 1rem auto;
                ...
                .cuerpo {
                    margin-top: 1.5rem;
                    padding: 0 3rem;
                    color: rgb(174, 196, 216);
                }
            }
            .box4 {
                //background: rgb(35, 76, 100);
            }
        }
    }
}
